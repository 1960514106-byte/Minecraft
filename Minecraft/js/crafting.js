...
const SHAPED_2 = [
  ...
  { shape: [BLOCK.PLANK, BLOCK.PLANK, null, ITEM.STICK], out: { id: ITEM.WOODEN_AXE, count: 1 } },
  { shape: [BLOCK.PLANK, null, ITEM.STICK, null], out: { id: ITEM.WOODEN_SHOVEL, count: 1 } },
  { shape: [null, BLOCK.PLANK, null, ITEM.STICK], out: { id: ITEM.WOODEN_SHOVEL, count: 1 } },
  ...
  { shape: [BLOCK.STONE, BLOCK.STONE, null, ITEM.STICK], out: { id: ITEM.STONE_AXE, count: 1 } },
  { shape: [BLOCK.STONE, null, ITEM.STICK, null], out: { id: ITEM.STONE_SHOVEL, count: 1 } },
  { shape: [null, BLOCK.STONE, null, ITEM.STICK], out: { id: ITEM.STONE_SHOVEL, count: 1 } },
  // Pressure plate: two stone side by side
  { shape: [BLOCK.STONE, BLOCK.STONE, null, null], out: { id: BLOCK.PRESSURE_PLATE, count: 1 } },
  { shape: [null, null, BLOCK.STONE, BLOCK.STONE], out: { id: BLOCK.PRESSURE_PLATE, count: 1 } },
];
...
const SHAPED_3 = [
  ...
  { shape: [null, BLOCK.PLANK, BLOCK.PLANK, null, ITEM.STICK, BLOCK.PLANK, null, ITEM.STICK, null], out: { id: ITEM.WOODEN_AXE, count: 1 } },
  { shape: [BLOCK.STONE, BLOCK.STONE, null, BLOCK.STONE, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.STONE_AXE, count: 1 } },
  { shape: [null, BLOCK.STONE, BLOCK.STONE, null, ITEM.STICK, BLOCK.STONE, null, ITEM.STICK, null], out: { id: ITEM.STONE_AXE, count: 1 } },
  ...
  { shape: [null, ITEM.IRON_INGOT, ITEM.IRON_INGOT, null, ITEM.STICK, ITEM.IRON_INGOT, null, ITEM.STICK, null], out: { id: ITEM.IRON_AXE, count: 1 } },
  ...
  { shape: [null, ITEM.DIAMOND, ITEM.DIAMOND, null, ITEM.STICK, ITEM.DIAMOND, null, ITEM.STICK, null], out: { id: ITEM.DIAMOND_AXE, count: 1 } },
  ...
  { shape: [ITEM.STRING, ITEM.STICK, null, ITEM.STRING, null, ITEM.STICK, ITEM.STRING, ITEM.STICK, null], out: { id: ITEM.BOW, count: 1 } },
  ...
  // Hoes: two material blocks on top, sticks down the middle (both mirror shapes)
  { shape: [BLOCK.PLANK, BLOCK.PLANK, null, null, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.WOODEN_HOE, count: 1 } },
  { shape: [null, BLOCK.PLANK, BLOCK.PLANK, null, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.WOODEN_HOE, count: 1 } },
  { shape: [BLOCK.STONE, BLOCK.STONE, null, null, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.STONE_HOE, count: 1 } },
  { shape: [null, BLOCK.STONE, BLOCK.STONE, null, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.STONE_HOE, count: 1 } },
  { shape: [ITEM.IRON_INGOT, ITEM.IRON_INGOT, null, null, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.IRON_HOE, count: 1 } },
  { shape: [null, ITEM.IRON_INGOT, ITEM.IRON_INGOT, null, ITEM.STICK, null, null, ITEM.STICK, null], out: { id: ITEM.IRON_HOE, count: 1 } },
  ...
  { shape: [null, null, null, ITEM.IRON_INGOT, null, ITEM.IRON_INGOT, ITEM.IRON_INGOT, ITEM.IRON_INGOT, ITEM.IRON_INGOT], out: { id: ITEM.MINECART, count: 1 } },
  ...
  { shape: [BLOCK.REDSTONE_TORCH, ITEM.REDSTONE, BLOCK.REDSTONE_TORCH, BLOCK.STONE, BLOCK.STONE, BLOCK.STONE, null, null, null], out: { id: BLOCK.REPEATER, count: 1 } },
...
function matchesShape(shape, slots) {
  for (let i = 0; i < shape.length; i++) {
    const need = shape[i];
    const slot = slots[i];
    if (need == null) {
      if (slot && slot.count > 0) return false;
    } else if (!slot || slot.id !== need || slot.count <= 0) {
      return false;
    }
  }
  return true;
...
function matchedRecipe(grid, size) {
  ...
  const shaped = size === 3 ? SHAPED_3 : SHAPED_2;
  for (const r of shaped) {
    if (matchesShape(r.shape, slots)) return { out: r.out, cost: shapeCost(r.shape) };
  }
